        ...
        <div>
            ...
            <div className='title-class d-flex'>
                ...
                <div className='col-md-7 ml-1 d-flex' style={{ justifyContent: "flex-start" }}>
                    <h2 className='text-center text-white mr-5'>تفاصيل البرنامج</h2>
                </div>
            </div>
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-md-12">
                                <h3 className='text-dark'>برنامج 1 - هوليداي إن إكسبريس - ليثبريدج</h3>
                                <form action="/choosestudent">
                                    ...
                                    <button type="submit" className='btn m-auto d-block w-50 select-student-btn fw-bold text-dark'>اختر طالب</button>
                                </form>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="container">
                            <div className="row">
                                ...
                                <div className='description-details mt-5'>
                                    ...
                                    <p>انطلق في رحلة سباحة شخصية مع مجموعة أولياء الأمور ودروس الأطفال في مدرسة K&K Swim School ، المصممة خصيصا للسباحين الذين تتراوح أعمارهم بين 5 و 12 شهرا. هذه البرامج الأسبوعية التي تستغرق 30 دقيقة تفعل أكثر من مجرد تعليم السباحة. نحن نرعى علاقة خاصة بين السباح والماء. تصبح مساحة حمام السباحة المشتركة لدينا بيئة يتم فيها بناء الثقة وتبني التحديات ، كل ذلك تحت إشراف مدربينا المتحمسين.</p>

                                    <p className='my-2'>في دروس الوالدين والطلاب الجماعية ، نمكنك من أن تصبح أول مدرب سباحة لطفلك. هذه البرامج ليست فقط حول دعم طفلك. إنهم يشاركون بنشاط في رحلة السباحة الخاصة بهم. مع نسبة 3 إلى 1 من الأطفال إلى المدربين ، نوجهك أنت وطفلك الصغير إلى هذه البيئة الجديدة ، مما يضمن لك الشعور بالثقة والاتصال في الماء.</p>
