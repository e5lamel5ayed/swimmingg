...
import TrainingProgramDialog from "./TrainingProgramDialog"; // Adjust the import path as necessary

const poolData = {
    'حمام 1': {
        '9.00 - 10.00 ص': [
            { lane: 'حارة 1', status: 'مغلق', program: 'برنامج 1' },
            { lane: 'حارة 2', status: 'مفتوح' },
            { lane: 'حارة 3', status: 'مفتوح' },
            { lane: 'حارة 4', status: 'مغلق', program: 'برنامج 2' },
            { lane: 'حارة 5', status: 'مغلق', program: 'برنامج 5' },
            { lane: 'حارة 6', status: 'مفتوح' },
            { lane: 'حارة 7', status: 'مفتوح' },
            { lane: 'حارة 8', status: 'مغلق', program: 'برنامج 6' },
        ],
    },
    'حمام 2': {
        '9.00 - 10.00 ص': [
            { lane: 'حارة 1', status: 'مغلق', program: 'برنامج 7' },
            { lane: 'حارة 2', status: 'مفتوح' },
            { lane: 'حارة 3', status: 'مفتوح' },
            { lane: 'حارة 4', status: 'مغلق', program: 'برنامج 8' },
        ],
    },
    'حمام 3': {
        '9.00 - 10.00 ص': [
            { lane: 'حارة 1', status: 'مغلق', program: 'برنامج 13' },
            { lane: 'حارة 2', status: 'مفتوح' },
            { lane: 'حارة 3', status: 'مفتوح' },
        ],
    },
